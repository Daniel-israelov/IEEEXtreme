...
int main() {
    ...
    if (negative_in_n == n && negative_in_m == m) {
        ttl_res = all_mult_sum(arrN, n, arrM, m);
    }
    ...
    //if both arrays has midex signs (positive & negative)
    else {
...
long all_mult_sum(long* const& arrN, long sizeN, long* const& arrM, long sizeM) {
    long sum = 0;
